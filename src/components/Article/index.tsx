      ...
      <div className="article__cards-field">
        <div className="article__cards">
          {articles.map((article: IArticle, index: number) => {
            if (index < 3) {
              return (
                <div className="article__card" style={{ backgroundImage: `url(${article.img})` }} onClick={() => handleArticleClick(article.id)}>
        ...
        <div className="article__further h6" onClick={() => handleClick('articles')}>
          См.далее
        </div>
      </div>
    </section>
